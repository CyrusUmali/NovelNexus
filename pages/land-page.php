...
if (count($most_borrowed_books) < 6) {
    $remaining_count = 6 - count($most_borrowed_books);
...
<section class="first-section">
    ...
    <div class="left">
        ...
        <div class="bg__blur2"></div>
        <h1>
            Welcome to our Library
        </h1>

        <p>
            Discover a world of knowledge, stories, and adventures. Our library offers a vast collection of books and resources to inspire, educate, and entertain. Whether you're here to learn, relax, or explore new ideas, there's something for everyone. Start your journey today!
        </p>
