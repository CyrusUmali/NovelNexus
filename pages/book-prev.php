    ...
    <div class="book-2">
        ...
        <div class="block-1" style="margin-top:40px">
            ...
            <div class="rating">
                ...
                <?php if ($book['accesslvl'] === 0): ?>
                    <span class="access-level free">Free Access</span>
                <?php elseif ($book['accesslvl'] === 1): ?>
                    <span class="access-level paid">Paid Access</span>
                <?php endif; ?>
            ...
            <div class="book-summary">
                <?php
                $content = $book['about']; // Assume this contains your HTML content
                $dom = new DOMDocument();
                ...
                foreach ($xpath->query('//@style') as $styleAttr) {
                    $styleAttr->parentNode->removeAttribute('style');
                }
                ...
                ?>
                        <div class="item">
                            ...
                            <div class="right">
                                <div class="row-1">
                                    <div class="col-1">
                                        <div class="rating-wrapper" id="communityrev">
                                            <div>
                                                <?php
